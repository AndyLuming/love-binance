...
public class XAxisRenderer extends AxisRenderer {
    ...
    public void renderAxisLine(Canvas c) {
        ...
        if (mXAxis.getPosition() == XAxisPosition.BOTTOM
            ...
            Rect bound = new Rect();
            mAxisLabelPaint.getTextBounds("0", 0, 1, bound);
            float yoffset = mXAxis.getYOffset();
            float bottom  = mXAxis.getYOffset() + (bound.bottom - bound.top);

            c.drawLine(mViewPortHandler.contentLeft(),
                    mViewPortHandler.contentBottom() - yoffset, mViewPortHandler.contentRight(),
                    mViewPortHandler.contentBottom() - yoffset, mAxisLinePaint);

            c.drawLine(mViewPortHandler.contentLeft(),
                    mViewPortHandler.contentBottom() + bottom, mViewPortHandler.contentRight(),
                    mViewPortHandler.contentBottom() + bottom, mAxisLinePaint);
        }
    }
